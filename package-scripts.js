...
module.exports = {
    scripts: {
         ...
         */
        config: {
            script: series(runFast('./src/common/commands/tsconfig.ts')),
            hiddenFromHelp: true,
        },
        /**
        ...
        db: {
            ...
            seed: {
                script: series('nps banner.seed', 'nps config', runFast('./src/common/commands/seed.ts')),
...
function banner(name) {
    return {
        ...
        script: runFast(`./src/common/commands/banner.ts ${name}`),
    };
}
